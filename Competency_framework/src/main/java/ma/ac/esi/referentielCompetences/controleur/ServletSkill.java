...
public class ServletSkill extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request dispatcher transfere la requette  au fichier .jsp
		request desipatcher permet d afficher la reponse de la requette a l utilisateur 
		 */
		//modification pour afficher une liste et non pas juste un message:
		if (succes) {
